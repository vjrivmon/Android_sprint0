...
// la clase Utilidades es una clase de utilidades que contiene métodos estáticos para convertir entre tipos de datos
// y para hacer otras operaciones útiles en la aplicación
public class Utilidades {
    ...
    // Sirve para convertir un String en un array de bytes
    ...
    // Sirve para convertir un String en un UUID (un identificador único universal)
    ...
    // Sirve para convertir un UUID en un String
    ...
    // Sirve para convertir un UUID en un String hexadecimal
    ...
    public static String bytesToString( byte[] bytes ) {
        ...
        for (byte b : bytes) {  // recorremos el array de bytes
            sb.append( (char) b ); // añadimos el byte al StringBuilder
        }
        return sb.toString();
    }
    ...
    // Sirve para convertir dos longs en un array de bytes
    ...
    // -------------------------------------------------------------------------------
    // <byte> - bytesToInt - N
    // Sirve para convertir un array de bytes en un entero
    ...
    // -------------------------------------------------------------------------------
    // <byte> - bytesToLong - N
    // Sirve para convertir un array de bytes en un long
    ...
    public static int bytesToIntOK( byte[] bytes ) {
        ...
        if ( bytes.length > 4 ) {
            throw new Error( "demasiados bytes para pasar a int ");  // si hay más de 4 bytes, lanzamos una excepción
        }
        int res = 0;
    ...
    // Sirve para convertir un array de bytes en un String hexadecimal
    public static String bytesToHexString( byte[] bytes ) {
        ...
        StringBuilder sb = new StringBuilder();   // StringBuilder es una clase que permite concatenar cadenas de texto
        for (byte b : bytes) {      // recorremos el array de bytes
            sb.append(String.format("%02x", b)); // añadimos el byte al StringBuilder
            sb.append(':');
        }
        return sb.toString();
    } // ()
